  ...
  return (
    <div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <ScoreRing label="Maintainability Score" score={scores.maintainability} />
        <ScoreRing label="Security Score" score={scores.security} />
        <ScoreRing label="Architecture Score" score={scores.architecture} />
      </div>
    </div>
  );
}
